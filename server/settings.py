...
ALLOWED_HOSTS = ['.backend.themajoceanic.com', '*']
...
INSTALLED_APPS = [
    ...
    'page_navigation.apps.PageNavigationConfig'
]
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME': datetime.timedelta(hours=23),
